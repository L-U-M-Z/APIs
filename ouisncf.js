...
function getTrainInfos(numero, date) {
...
function searchTrainsCalendar(options) {
...
function searchTrainsByDate(options) {
...
function searchBestOffer(options) {
...
await searchBestOffer({
    codeA   : "FRBOJ",         // Bordeaux Saint-Jean
    codeB   : "FRAEG",         // Strasbourg
    date    : "2021-06-12"
});
